const zhCN = {
  ...
  enableExecChannelHint:
    '用于系统信息、root 视角、终端目录跟随和用户状态同步。如果连接后立刻断开，先关闭它再试；关闭后这些能力也会停用。',
...
const enUS: typeof zhCN = {
  ...
  enableExecChannelHint:
    'Used for system info, root file access, terminal directory following, and user-state sync. If login drops immediately, turn it off; these capabilities will also be disabled.',
