  ...
  return (
    <div className="window-menubar">
      <div className="window-menu-items">
        <button type="button" onClick={(event) => openWindowMenu('file', event.currentTarget)}>File</button>
        <button type="button" onClick={(event) => openWindowMenu('view', event.currentTarget)}>View</button>
        <button type="button" onClick={(event) => openWindowMenu('window', event.currentTarget)}>Window</button>
      </div>
