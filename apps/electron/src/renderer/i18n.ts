const zhCN = {
  ...
  detachTab: '移到独立窗口',
  attachTab: '移回主窗口',
  tabDragSortHint: '松开以调整标签顺序',
  tabDragDetachHint: '松开以新建独立窗口',
  tabDragAttachHint: '松开以合并到此窗口',
  tabDragBlockedHint: '此标签不能移到独立窗口',
  connect: '连接',
  connectAll: '连接全部',
  disconnect: '断开',
  closeOthers: '关闭其他',
  ...
  closeWorkspaceConfirmTitle: '关闭工作区窗口',
...
const enUS: typeof zhCN = {
  ...
  detachTab: 'Move to New Window',
  attachTab: 'Move Back to Main Window',
  tabDragSortHint: 'Release to reorder tabs',
  tabDragDetachHint: 'Release to create a new window',
  tabDragAttachHint: 'Release to merge into this window',
  tabDragBlockedHint: 'This tab cannot be moved to a separate window',
  connect: 'Connect',
  ...
  closeWorkspaceConfirmTitle: 'Close Workspace Window',
  ...
  closeConfirmWorkspace: 'Close This Window',
